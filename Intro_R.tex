...
\phantomsection\label{r-is-prone-to-errors}
\begin{itemize}
\item
...
\phantomsection\label{r-studio-projects}
\begin{itemize}
\item
...
\phantomsection\label{code-versus-comment}
...
\phantomsection\label{commends-to-index-your-scrips}
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Library{-}{-}{-}{-}}
...
\phantomsection\label{about-tidy-data}
...
\phantomsection\label{pipe-operator}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Pipe operator}
\phantomsection\label{pipe-operator-1}
...
\phantomsection\label{importing-data-in-r}
...
\phantomsection\label{exploring-the-data}
...
\begin{frame}[fragile]{Exploring the data}
\phantomsection\label{exploring-the-data-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{manipulating-data}
...
\phantomsection\label{from-wide-to-long}
...
\phantomsection\label{group_by-and-summarize}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{filter---subset-rows}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{select---subset-columns}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{plotting-data}
...
\phantomsection\label{ggplot-layers}
\begin{figure}[H]
...
\phantomsection\label{plotting-iris}
\end{frame}
...
\phantomsection\label{saving-plots}
...
\phantomsection\label{to-go-further}
